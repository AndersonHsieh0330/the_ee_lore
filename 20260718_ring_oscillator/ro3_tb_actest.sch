...
B 2 650 -1360 1450 -960 {flags=graph
y1=1e-35
y2=0.01
ypos1=0
ypos2=2
...
logx=0
logy=0
rawfile=$netlist_dir/ro3_ac.raw
autoload=1
sim_type=ac
color=4
node="frequency analysis; out"}
...
C {vsource.sym} 140 -130 0 0 {name=V1 value="1.2 AC 1" savecurrent=false}
...
C {devices/code_shown.sym} 80 -860 0 0 {name=MODEL only_toplevel=true
